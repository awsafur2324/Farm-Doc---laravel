...
<section class="event-two">
    <div class="container">
        <div class="block-title text-center">
            <p>01. Knowledge Valley...</p>
            <h3>Let’s Enhance Ur Knowledge <br> Farm Doc...</h3>
        </div><!-- /.block-title -->
        <div class="row no-gutters">


@foreach ($NewsPosts  as  $iteam)


<div class="col-xl-6">
<div class="event-two__single">
<div class="event-two__image">
    <img src="{{ (! empty($iteam->photo)) ? url('upload/news_post/'.$iteam->photo):url('upload/no_image.jpg') }}" style="width: 400px; height:400px";>
    
</div><!-- /.event-two__image -->
<div class="event-two__content d-flex">
    <div class="my-auto">
        <div class="event-two__date"><b>25</b> <span>Mar</span></div><!-- /.event-two__date -->
        <h3><a href="event-details.html">{{ $iteam->heading }}</a></h3>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6">
                    <div class="cta-two__content">
                        ...
                        <a href="{{ route('user.Contact') }}" class="thm-btn cta-two__btn">Get Appointment</a><!-- /.thm-btn cta-two__btn -->
                        ...
                        <div class="accrodion-grp" data-grp-name="career-one__accrodion">
                            <div class="accrodion ">
                                <div class="accrodion-title">
                                    <h4>How Farm Doc Done Their Work?</h4>
                                </div>
                                <div class="accrodion-content">
                                    <div class="inner">
                                        <p>Giving an easy way communication</p>
                                        <ul class="list-unstyled career-one__content-list">
                                            <li>increase knowledge of farmar</li>
                                            <li>Well organized System</li>
                            ...
                            <div class="accrodion active">
                                <div class="accrodion-title">
                                    <h4>How to take appoirnment in Farm Doc</h4>
                                </div>
                                <div class="accrodion-content">
                                    <div class="inner">
                                        
                                        <ul class="list-unstyled career-one__content-list">
                                        <li>First Register in this system</li>    
                                        <li>Discribe you'r problem in appoirnment field</li>
                            ...
                            <div class="accrodion">
                                <div class="accrodion-title">
                                    <h4>Is Farmdoc the best Agriculture supporter?</h4>
                                </div>
                                <div class="accrodion-content">
                                    <div class="inner">
                            ...
                            <div class="accrodion">
                                <div class="accrodion-title">
                                    <h4>I need help managing my Account</h4>
                                </div>
                                <div class="accrodion-content">
                                    <div class="inner">
                                        <p>Our goal each day is to ensure that our residents’ needs are not only
