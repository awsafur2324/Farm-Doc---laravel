<section class="slider-one__wrapper">
    ...
    <div class="slider-one__carousel owl-carousel owl-theme thm__owl-carousel" data-options='{
        ...
        <div class="item" style="background-image: url({{ asset('Frontend/assets/img/b2.jpg') }});">
                        ...
                        <div class="col-lg-12 d-flex justify-content-end">
                            <div class="slider-one__content">
                                <div class="slider-one__content-inner">
                                    ...
                                    <a href="{{ route('user.Contact') }}" class="thm-btn slider-one__btn">Appointment
                                        Now</a>
        ...
        <div class="item" style="background-image: url(Frontend/assets/img/b1.jpg);">
            <div class="slider-one__item">
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-lg-12 d-flex justify-content-end">
                            <div class="slider-one__content">
                                <div class="slider-one__content-inner">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                        tempor incididunt labore dolore magna aliqua enim ad minim veniam.</p>
                                    <a href="{{ route('user.Services') }}" class="thm-btn slider-one__btn">Knowledge valley
                                        </a>
                                    <!-- /.thm-btn slider-one__btn -->
                                </div><!-- /.slider-one__content-inner -->
                            </div><!-- /.slider-one__content -->
        ...
        <div class="item" style="background-image: url(Frontend/assets/img/b3.jpg);">
            <div class="slider-one__item">
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-lg-12 d-flex justify-content-end">
                            <div class="slider-one__content">
                                <div class="slider-one__content-inner">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                        tempor incididunt labore dolore magna aliqua enim ad minim veniam.</p>
                                    <a href="#" class="thm-btn slider-one__btn">Donate
                                        Now</a>
                                    <!-- /.thm-btn slider-one__btn -->
                                </div><!-- /.slider-one__content-inner -->
                            </div><!-- /.slider-one__content -->
