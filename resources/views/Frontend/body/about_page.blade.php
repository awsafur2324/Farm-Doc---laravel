...
<body>
    ...
    <div class="page-wrapper">
      ...
      @include('Frontend.body.topbar')
       ...
       @include('Frontend.body.header')
        ...
        <section class="page-header" style="background-image: url(assets/images/background/page-header-about-1.jpg);margin-bottom:0px;">
            <div class="container">
                <h2>About Us</h2>
    ...
    <section class="service-one service-one__service-page border-0">
...
<div class="col-md-4 mb-4">
    <div class="card" style="width: 18rem;">
        ...
        alt="Admin" class="img-thumbnail card-img-top"  style="width:300px; height: 300px;">
...
@endforeach
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            ...
            <p class="side-menu__block__copy">(c) 2021 <a href="#">FarmDoc</a> - All rights reserved.</p>
